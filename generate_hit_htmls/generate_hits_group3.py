...
def generate_one_hit(html_template_file, generations, prompts, labels, output_html_folder_path, hit_index, voting_file_path):
    ...
    answers = voting_results[f'hit{hit_index[10:]}']['Answers']
    ...
    for i in range(len(generations)):
        ...
        paragraph1_voting_reason = [
            f"""
            <svg class="worker-icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-check-fill" viewBox="0 0 16 16">
